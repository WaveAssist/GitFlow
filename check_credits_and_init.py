...
project_name = waveassist.fetch_data("project_name")
...
github_access_token = waveassist.fetch_data("github_access_token")
github_selected_resources = waveassist.fetch_data("github_selected_resources")
...
if not github_selected_resources or len(github_selected_resources) == 0:
    display_output = {
...
print(f"GitFlow: Initialized for project '{project_name.strip()}'")
